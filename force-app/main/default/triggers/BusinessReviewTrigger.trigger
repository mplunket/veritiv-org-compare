trigger BusinessReviewTrigger on Pipeline_Review__c (after insert) {

    //Logic to share pipeline review record with owners manager
    
    if(trigger.isInsert && trigger.isAfter){
        Map<Id, Id> pipelineIdVsOwnerId = new Map<Id,Id>();
        for(Pipeline_Review__c pR: trigger.new){
